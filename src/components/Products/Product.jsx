...
const Product = ({ price, img, name, _id, description, sales }) => {
 ...
 return (
    <div className={'group bg-stone-900 text-white shadow duration-150 rounded-xl  hover:scale-105 hover:shadow-md'}>
      <NavLink  to={`/detail/${_id}`}>     
        ...
        <div class="flex mb-3 items-center">
          <p className='ml-4 text-xl font-semibold text-gray-800'>${price}</p>
